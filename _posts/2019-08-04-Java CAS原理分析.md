...
3. 写入的新值
#### CAS流程
内存地址区域的值和要比较的值进行比较, 如果相等, 那么就写入新的值. 否则什么都不做.<br>
...
>参考材料:
><<Java并发编程实战>><br>
>[JAVA CAS原理深度分析](https://zl198751.iteye.com/blog/1848575) <br>
>[并发编程之 CAS 的原理](https://blog.csdn.net/qq_38182963/article/details/78998656) <br>
